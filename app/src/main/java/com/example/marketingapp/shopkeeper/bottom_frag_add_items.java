...
public class bottom_frag_add_items extends BottomSheetDialogFragment {
        ...
        binding.addprodctsFrag.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isChk()) {
                    ...
                    Toasty.normal(getContext(),"Product Image will be Updated Soon...").show();
                    dismiss();
                }
            }
        });
    ...
    private boolean isChk() {
        ...
        {
            Toasty.error(getContext(),"Please add an image of Your Product").show();
            return false;
        }
        ...
        {
            Toasty.error(getContext(),"Please enter all the fields").show();
            return false;
        }
        return true;
    }
